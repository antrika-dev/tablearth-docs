...
TableAI lets users ask natural-language questions of any tabular dataset and get back text, charts, and a generated dashboard. It can be embedded in any web product, in Microsoft Excel, in Google Chrome, or called server-to-server.

This repo is the integration handbook. If you're shipping TableAI inside your own surface, start here.
...
| **Excel add-in** | Letting users analyse a sheet from inside Excel (Win/Mac/Web). | [docs/integrations/excel-addin.md](docs/integrations/excel-addin.md) |
...
- **My users live in spreadsheets** → Excel add-in.
...
- [Auth modes](docs/api/auth.md) — which credential goes where, and why there are three.
...
If something blocks your integration, contact your tenant administrator or the TableAI support channel with:

- The surface (widget / Chrome extension / Excel add-in / REST).
